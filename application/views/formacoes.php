...
<section class="col-sm-10 offset-sm-2">
    <div class="card p-3 mx-1 shadow" style="margin-top: 70px;">
        ...
        <div class="text-right">
            <button type="button" id="btn-novo" class="btn btn-success" data-toggle="modal" data-target="#modal-cad">Nova Formação</button>
        </div>
        ...
        <form id="form-pesquisa" class="mt-3 mx-5">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="search-curso" name="search-curso">
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="campo" id="campo1" value="nome_curso" checked>
                    <label class="form-check-label" for="campo1">Pelo Nome do Curso</label>
                </div>
                <div class="form-check form-check-inline">
