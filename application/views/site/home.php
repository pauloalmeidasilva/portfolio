...
<head>
	...
	<link rel="stylesheet" href="<?=CSS.'core/all.min.css'?>">
...
<div class="arlo_tm_wrapper_all">
	...
	<div class="arlo_tm_mobile_header_wrap">
		<div class="main_wrap">
			<div class="logo">
				<img src="<?=IMG.'logo_mobile.png'?>" alt="Paulo Ricardo" class="img-fluid" style="max-width: 150px;"> 
			</div>
	...
	<div class="arlo_tm_content">
		...
		<div class="arlo_tm_leftpart_wrap">
			<div class="leftpart_inner">
				...
				<a class="arlo_tm_resize" href="#"><i class="fas fa-chevron-left"></i></a>
			</div>
		</div>
		<!-- /LEFTPART -->
							...
							<div class="content hero">
								<div class="inner_content">
									...
									<div class="name_holder">
										<h3>Paulo <span>Ricardo</span></h3>
									</div>
									<div class="text_typing">
										<p>Eu sou <span class="arlo_tm_animation_text_word"></span></p>
									</div>
								</div>
							</div>
							<div class="arlo_tm_arrow_wrap bounce anchor">
								<a href="#about"><i class="fas fa-angle-double-down"></i></a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="author_wrap">
									...
									<div class="rightbox">
										...
										<div class="buttons_wrap">
											<ul>
												<li>
													<a href="#"><span>Baixar Currículo</span></a>
												</li>
												<li class="anchor">
													<a href="#contact"><span>Entre em Contato</span></a>
												</li>
											</ul>
										</div>
									</div>
...
<!-- / WRAPPER ALL -->
	...
	<script type="text/javascript" src="<?=JS.'core/all.min.js'?>"></script>
	<script type="text/javascript" src="<?=JS.'template/plugins.js'?>"></script>
	<script type="text/javascript" src="<?=JS.'template/init.js'?>"></script>
</body>
</html>